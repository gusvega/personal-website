...
export const article = {
  date: '2023-02-18',
  title: 'Short-Term Rental Real Estate Analysis Tool',
  link: 'https://real-estate.gusvega.dev',
  description:
    'The Short-Term Rental Real Estate Analysis Tool that provides insights for property investors to assess rental income potential and optimize strategies, maximizing profitability.',
  author: {
