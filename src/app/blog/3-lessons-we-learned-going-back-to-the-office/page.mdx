...
export const article = {
  ...
  description:
    'The Short-Term Rental Analysis Tool that provides insights for property investors to assess rental income potential and optimize strategies, maximizing profitability. Implementing Machine learing to learn patters in the real estate market',
  author: {
