...
export const article = {
  date: '2023-04-06',
  title: 'DevOps Automation Pipelines Dashboard',
  link: 'https://devops-dashboard.gusvega.dev',
  description:
    'The Centralized DevOps Automation Pipelines Dashboard provides real-time visualizations for all stages of software development, optimizing workflows and fostering efficiency across teams.',
  author: {
    name: 'Chelsea Hagon',
