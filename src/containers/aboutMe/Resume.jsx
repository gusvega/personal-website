...
function Resume() {
   ...
   return (
      <>
         ...
         <div className='flex flex-row ml-4 bg-white h-full'>
            ...
            <Col md={8} order={0} className="order-md-1 w-2/3 flex flex-col justify-center">
               ...
               <button className="w-100 hover:bg-slate-100 p-3">
                  <Card style={{ border: '0' }}>
                     <Card.Body style={{ fontFamily: 'Amiko' }}>
                        <Card.Title className='items-start flex text-red-500' onClick={() =>  downloadResume() } style={{ fontFamily: 'Montserrat', fontWeight: '800' }}>/ DOWNLOAD RESUME</Card.Title>
                     </Card.Body>
                  </Card>
