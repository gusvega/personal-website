            ...
            <div className=' h-screen w-2/3 flex flex-col ml-40'>
               <div className='w-full h-1/2 flex flex-col'>
                  ...
                  <div className=' h-1/4 p-4 m-4 text-lg text-red-600'>
                     ...
                     <Typewriter
                        onInit={(typewriter) => {
                           typewriter.typeString('Hola! .... I love automating things .... ')
                              .callFunction(() => {
                                 // console.log('String typed out!');
                              })
                              .pauseFor(2500)
                              .deleteAll()
                              .typeString('I am a DevOps Engineer with a focus in Javascript Ecosystems [React and Node to be more specific]... and I can develop web apps with those tools too  :)')
                              .start();
                        }}
                     />
